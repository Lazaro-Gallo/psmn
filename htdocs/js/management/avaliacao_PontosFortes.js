            ...
            update: function (element) {
                ...
                element._.micros.each(function (index, micro) {
                    ...
                    micro._.options.filter(':checked').each(function (index, option) {
                        ...
                        var $valor_total = (micro._.score.total + option._.question.score);

                        if($valor_total == 17) $valor_total = $valor_total - 1;
                        if($valor_total == 18) $valor_total = $valor_total - 1;
                        if($valor_total == 19) $valor_total = ($valor_total) - 1;
                        if($valor_total == 20) $valor_total = ($valor_total) - 1;
                        if($valor_total == 21) $valor_total = ($valor_total) - 1;
                        
                        micro._.score.total = $valor_total; 
