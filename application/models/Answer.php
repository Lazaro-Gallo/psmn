...
class Model_Answer
{
    ...
    {
        $this->tbAnswer = new DbTable_Answer();
    ...
    public function createAnswer($data, $alternativeRow)
    {
        ...
        try {
            ...
            $answerRow = DbTable_Answer::getInstance()->createRow()
            ...
            $AnswerHistory = new Model_AnswerHistory();
    ...
    function getAll()
    {
        return $this->tbAnswer->fetchAll();
    }

    function getAnswerById($Id)
    {
        $objResultAnswer = $this->tbAnswer->fetchRow(array('Id = ?' => $Id));
