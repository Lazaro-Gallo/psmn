     ...
     <?php
      ...
      <div id="tab-<?php echo $cont; ?>" class="tab-item" style="height: auto">      
        <form action="" class="formsubmitfull" data-question-id="<?php echo $questionId; ?>">
         ...
         <div class="helper-questions">
         <p class="title-helper-questions">Resposta do Verificador:</p>    
         </div>
         </br>
        <div class="answers" style="height: 146px">
            <?php
          ...
          <?php if ($question['ShowEnterpriseFeedback']):1?>
              <div class="complement">
               
          <textarea name="comentarioItemverificador<?php echo $alternativeId; ?>" style="width: 800px; height: 110px;"></textarea> 
